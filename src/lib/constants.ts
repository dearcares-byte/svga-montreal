...
export const EVENTS = [
  {
    ...
    price: "Free",
    tag: "Social" as const,
    desc: "A warm evening of home-cooked Caribbean dishes, live music, and community connection. Everyone is welcome — bring a dish to share!",
  },
  {
    month: "APR",
    day: "20",
    ...
    desc: "Connecting young Vincentians with established professionals for academic advice, career guidance, and personal development.",
  },
  {
    month: "MAY",
    day: "10",
    title: "Youth Achievement Awards Night",
    location: "Centre St-Pierre, Plateau",
    time: "7:00 PM",
    price: "$20 / ticket",
    tag: "Education" as const,
    desc: "An annual evening honouring Vincentian students and young community members who have excelled academically and in service.",
  },
  {
    month: "JUN",
    day: "08",
    ...
    desc: "Our biggest outdoor event of the year — live soca and calypso, island cuisine, craft vendors, and family activities for all ages.",
  },
  {
    month: "AUG",
    day: "23",
    ...
    price: "Free",
    tag: "Education" as const,
    desc: "Distributing school supplies and backpacks to children in our community before the new school year, with activities and refreshments.",
  },
  {
    month: "SEP",
    day: "06",
    title: "SVG Heritage Night",
    location: "Salle du Gésu, Downtown",
    time: "7:30 PM",
    price: "$15 / ticket",
    tag: "Cultural" as const,
    desc: "An intimate evening celebrating Vincentian music, poetry, cuisine, and storytelling — a love letter to our islands.",
  },
  {
    month: "OCT",
    day: "27",
    ...
    desc: "Our flagship black-tie gala commemorating SVG Independence Day with a formal dinner, live entertainment, awards, and dancing.",
  },
] as const;
...
export const SIGNATURE_EVENTS = [
  {
    ...
    desc: "Our most anticipated event of the year. Every October, we gather in formal attire to celebrate the independence of St. Vincent and the Grenadines with dinner, awards, and entertainment.",
    detail: "Held annually since 2007 · Black-tie · 300+ attendees",
  },
  {
    month: "JUN",
    title: "Caribbean Culture Festival",
    ...
    desc: "A free outdoor celebration of Caribbean culture featuring live soca and calypso music, authentic island food, craft vendors, and family-friendly activities at Parc Jean-Drapeau.",
    detail: "Held every June · Free admission · All ages welcome",
  },
  {
    month: "DEC",
    ...
    desc: "Each December, our members come together to collect and deliver food hampers to families across Montreal. In 2025 we distributed over 200 baskets to families in need.",
    detail: "Held every December · Volunteers welcome · Community-wide",
  },
  {
    month: "MAY",
    ...
    desc: "An annual ceremony recognizing Vincentian youth who have demonstrated excellence in academics, athletics, arts, or community service throughout the year.",
    detail: "Held every May · Nominations open in March · Scholarship awards",
  },
] as const;
